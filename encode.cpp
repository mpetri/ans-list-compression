...
int main(int argc, char const* argv[])
{
    ...
    auto stats = compress_lists(method, inputs, out_file, meta_file);
    ...
    std::cout << "space(" << stats.method << ") " << bpi << " bits per integer"
              << std::endl;
    std::cout << "encodingspeed(" << stats.method << ") " << mints_per_sec
